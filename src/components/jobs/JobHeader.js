...
const JobHeader = ({ sort, setSort, total, totalFound, setLimit, filter }) => {
  return (
    <div className="flex flex-col lg:flex-row  gap-8  justify-between py-4 items-center mb-4 sticky top-14 bg-white shadow-md px-5 rounded-lg mb-3">
      <h3 className=" font-semibold w-full">Total jobs : {total}</h3>
