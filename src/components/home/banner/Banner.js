      ...
      <div className="flex lg:flex-row-reverse flex-col items-center">
        <div className="w-3/5   grid">
          <div className="flex justify-between w-full mt-8">
            <div className="featureCard1 lg:w-[150px] h-[10vh] px-3 py-2 lg:mr-10 mr-5  rounded-xl flex justify-between items-center bg-white">
          ...
          <img src={banner} className="w-full mx-5 mt-[-25px]" alt="banner" />
        ...
        <div className="lg:mr-5 mt-5 ">
          ...
          <div>
            ...
            <div className="grid grid-cols-8 gap-5 w-3/4 ">
              <input
                type="text"
              ...
              <div className="col-span-3">
                <button className="btn   btn-xl ">
                  <BsSearch className="mx-2" /> Search Jobs
                </button>
              </div>
            </div>
