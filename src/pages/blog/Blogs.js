        ...
        <div className='col-span-1 pl-7 py-8 '>
          <div className='lg:sticky top-20'>
            ...
            <div className='flex justify-between '>
              ...
              <Link to='/blogDetails' className=' bg-blue-50 hover:bg-blue-500 hover:text-white duration-500  py-1 rounded-lg ml-2 px-4'><BiSearch className=' inline  text-xl' /></Link>
            </div>
            <div>
              <h2 className='text-xl font-semibold mt-6 mb-4'>Categories</h2>
              {categories.map(category => <p className='capitalize mb-3'><BsDot className="inline mr-2 text-xl" />{category}</p>)}
            </div>
          </div>
        </div>
      </div>
