    ...
    return (
        <div className='mt-5 ml-4 '>
            {/* <div className='grid lg:grid-cols-3 grid-cols-1 lg:gap-5 gap-3 items-center justify-between my-8 '>
                <div className='bg-white  border-b-[#4485ff] border-b-4 text-[#4485ff]  p-7 flex justify-between items-center rounded-lg'>
                    ...
                    <div className=''>
                        ...
                        <p className='text-5xl text-end font-bold'>{applications?.length}</p>
                    </div>
                </div>
            ...
            {/* <div className='grid lg:grid-cols-2 gap-5'>
                <div className=' bg-white  px-6 py-6  rounded-lg'>
                    ...
                    <div className='text-center mt-2'>
                        ...
                        <h1 className='text-sm font-semibold capitalize'>{designation}</h1>
                    </div>
            ...
            <div className='mt-2'>
                ...
                <Link to='/dashboard/candidate-profile' className='text-blue-500 underline cursor-pointer'>Go to Profile</Link>
            </div>
