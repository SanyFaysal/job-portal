...
const EmployeeDashboardHome = () => {
    return (
        <div className='mx-4 '>
            <div className='grid grid-cols-3 gap-5 items-center justify-between my-8 '>
                <div className='bg-white border-b border-b-[#4485ff] border-b-4 text-[#4485ff] p-7 flex justify-between items-center rounded-lg'>
                    <div>
                    ...
                    <div className=''>
                        <h1 className='text-xl font-semibold'>Total Jobs</h1>
                        <p className='text-5xl text-end font-bold'>11</p>
                    </div>
                </div>
                <div className='bg-white border-b border-b-[#6f6ff3] border-b-4 text-[#6f6ff3] p-7 flex justify-between items-center rounded-lg'>
                    <div>
                ...
                <div className='bg-white text-[#b952f4f8] border-b border-b-4 border-b-[#b952f4f8] p-7 flex justify-between items-center  rounded-lg'>
                    <div>
